...
@push('javascript')
    ...
    <script type="text/javascript">
        ...
        var character_transactions = $('table#tax-payments').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('whtools.bluetaxpayments.data.bydate', [$daterange['start'],$daterange['end']]) }}'
        ...
        document.getElementById('month').onchange = function () {
            ...
            url = "{{ route('whtools.bluetaxpayments.bydate', ['start'=>'start','end'=>'end']) }}";
